...
class UserGridViewAdapter(val context: Context, data1: List<FaXian>) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        if(convertView == null){
            myHolder = MyHolder()
            view = LayoutInflater.from(context).inflate(R.layout.user_gridview_adapater ,null)
