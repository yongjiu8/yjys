...
import com.example.homebutton.faxianui.MusicPlayActivity
import com.example.homebutton.myview.X5WebView
import kotlinx.android.synthetic.main.activity_play.*

class MusicListAdapter(val context: Context, data: List<MusicList.DataBean.MusicListBean>) :
    RecyclerView.Adapter<MusicListAdapter.MyHolder>() {
    ...
    override fun onBindViewHolder(holder: MyHolder, position: Int) {
        ...
        holder.home.setOnClickListener {
            ...
            AppConfig.MusicDataList.addAll(dataList)
