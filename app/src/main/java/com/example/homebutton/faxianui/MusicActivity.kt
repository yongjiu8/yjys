...
import com.example.homebutton.adapter.MusicListAdapter
...
class MusicActivity : BaseActivity() {
    ...
    fun initData(bangId:String){
        ...
        loading(this)
        Net.getList("http://www.kuwo.cn/api/www/bang/bang/musicList?pn="+page+"&rn=30&httpsStatus=1&reqId=4c9685a0-12ac-11eb-b95d-ddb143e88229",parm,head,ck,object : NetCallBack{
